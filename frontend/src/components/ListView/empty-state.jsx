...
export const EmptyState = () => {
  ...
  const getRandomEmptyStateIllustration = () => {
    const emptyStateIllustrationsDark = [
      <EmptyStateDark />,
      <EmptyState2Dark />,
      <EmptyState3Dark />,
    ]
    const emptyStateIllustrationsLight = [
      <EmptyStateLight />,
      <EmptyState2Light />,
      <EmptyState3Light />,
    ]
    const emptyStateIllustrationsDarkToday = [
      <EmptyStateTodayDark />,
      <EmptyStateToday2Dark />,
    ]
    const emptyStateIllustrationsLightToday = [
      <EmptyStateTodayLight />,
      <EmptyStateToday2Light />,
    ]

    switch (defaultGroup) {
      case 'Checklist':
        return isLight
          ? emptyStateIllustrationsLightToday[index]
          : emptyStateIllustrationsDarkToday[index]
      ...
      default:
        return isLight
          ? emptyStateIllustrationsLight[index]
          : emptyStateIllustrationsDark[index]
    }
  }
      ...
      case 'Important':
        return (
          <>
            ...
            <p className='empty-state__body'>
              Tasks that you set to be important will show up here.
            </p>
          </>
        )
      ...
      default:
        return (
          <>
            <p className='empty-state__header'>
              {' '}
              Keep your tasks organized in projects
            </p>
            <p className='empty-state__body'>
  ...
  return (
    <div className='empty-state'>
      <div className='empty-state__illustration'>
        {getRandomEmptyStateIllustration()}{' '}
      </div>
